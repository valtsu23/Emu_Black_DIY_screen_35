...
Pcb on this picture is earlier prototype. Feather had faulty voltage booster so I had to delete it, but this won't be necessary if it's working correctly. 
